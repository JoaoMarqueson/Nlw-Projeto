...
export function InputRoot({ error = false, ...props }: InputRootProps) {
  return (
    <div
      data-error={error}
      className=" group flex items-center px-8 bg-gray-800 h-12 border border-gray-600 rounded-xl gap-2 focus-within:border-gray-100 data-[error=true]:border-danger"
      {...props}
    />
  )
}

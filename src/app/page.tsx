...
import { ArrowRightIcon, Mail, Radio, User } from 'lucide-react'
    ...
    <main className="max-w-[1240px] mx-auto px-5 py-8 md:py-0">
      <div className="min-h-dvh flex flex-col justify-center gap-16">
        <div className="flex flex-col gap-8 items-center md:items-start">
          <Image src={logo} alt="devastage" width={108.5} height={30} />
        ...
        <div className="flex gap-5 items-strech flex-col md:flex-row">
          <div className="flex-1 bg-gray-700 border border-gray-600 rounded-2xl p-8 space-y-6">
            ...
            <p className="text-gray-300 leading-relexade text-sm md:text-base">
          ...
          <form className="bg-gray-700 border border-gray-600 rounded-2xl p-8 space-y-6 w-full md:max-w-[440px]">
            ...
            <div className="space-y-3">
              <InputRoot>
                ...
                <InputField  type="text" placeholder="Digite Seu Nome Completo"/>
              </InputRoot>
